...
var todosDOMElement; // zu diesem Zeitpunkt ist der DOM noch nicht geladen (deshalb vor windows)
...
function drawListToDOM() {
    ...
    for (let index = 0; index < todoos.todosText.length; index++) { //mit var funktioniert das nicht!! nur mit let --> kann dann auch irgendwie global genutzt 
...
function updateCounter() {
    let open = 0;
    let done = 0;
    for (let i = 0; i < todoos.todosChecked.length; i++) {
